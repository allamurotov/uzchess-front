    ...
    return (
        ...
        <div className="min-h-screen text-white">
            <div className="mx-auto max-w-7xl px-4 py-6">
                <div className="relative overflow-hidden rounded-2xl border border-[#1d2733] mb-6">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between px-8 py-8 gap-6">
                        {/* Left */}
                ...
                <div className="flex flex-col gap-6 lg:flex-row">
                    ...
                    {/* Sections accordion */}
                    <div className="flex-1 overflow-hidden rounded-xl border border-[#1d2733] bg-[#121a24]">
                        {sections.slice().sort((a, b) => (a.order ?? 0) - (b.order ?? 0)).map((sec, si) => {
                            const secLessons = lessons
                                .filter(l => l.courseSectionId === sec.id)
                    ...
                    <div className="w-full lg:w-[280px] flex-shrink-0 flex flex-col gap-4">
                        ...
                        {isPurchased && lastLesson && (
                            <div className="bg-[#121a24] border border-[#1d2733] rounded-xl p-4">
                                ...
                                <div className="relative overflow-hidden rounded-xl cursor-pointer aspect-video"
                                    onClick={() => router.push(`/courses/${course.id}/lesson`)}>
